...
echo '</top><button id="tophide">Toggle</button></ul>';
echo "<br />";
echo $tlane . "<ul>";
...
echo '</mid>;<button id="midhide">Toggle</button></ul>';
echo "<br />";
echo $midinfo . "<ul>";
...
echo '</jg>
<button id="jghide">Toggle</button></ul>';
echo "<br />";
...
echo '</supp>
<button id="supphide">Toggle</button></ul>';
echo "<br />";
...
echo '</adc><button id="adchide">Toggle</button></ul>';
echo "<br />";
